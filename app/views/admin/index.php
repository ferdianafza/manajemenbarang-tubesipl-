  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="<?= BASEURL; ?>/admin">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL;?>/barangMasuk/create" method="post">
			...
			<div class="form-group">
			  <label for="nrp" class="form-label">Stok</label>
			  <input type="number" class="form-control" id="jumlah" name="jumlah" pattern="[0-9]*" required="" min="1" oninput="this.value = Math.max(1, this.value)">
			</div>
